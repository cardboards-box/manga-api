...
public static class ScheduleExtensions
{
    ...
    public static IServiceCollection AddScheduledTasks(this IServiceCollection services)
    {
        return services
            ...
            .AddTransient<PortainerContainerMonitor>();
    }
    ...
    public static async Task AddScheduledTasks(this WebApplication app)
    {
        ...
        {
            //schedule.Schedule<PortainerContainerMonitor>()
            //    .EverySeconds(10)
            //    .PreventOverlapping(nameof(PortainerContainerMonitor));
            ...
            PortainerContainerRestarts.Schedule(app.Services, schedule);
